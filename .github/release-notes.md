...
1. Descargá `AwayLock-*.zip` (abajo, en **Assets**) y descomprimilo.
2. Mové **AwayLock.app** a **Aplicaciones**.
3. Abrila. La primera vez macOS la va a bloquear (ver abajo).
...
Solo hace falta la primera vez. El código es abierto: podés revisarlo o compilarlo vos en lugar de descargar este archivo.
