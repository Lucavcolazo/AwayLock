...
(() => {
  ...
  const EN = {
    ...
    appTitle: "Two places, each for its own thing.",
    altMenu: "The menu bar panel in three states: near, walking away and locked.",
    menuT: "In the menu bar",
    menuP: "Whether you're near, leaving or away, the live meter, pause and lock now.",
    altWindow: "The AwayLock window with the iPhone list, distance thresholds, timings and options.",
    windowT: "In its own window",
    windowP: "Pick your iPhone and tune the distance while watching the meter. While it's open, it shows up in the Dock like any app.",
    appSpanish: "The app itself is in Spanish for now.",
